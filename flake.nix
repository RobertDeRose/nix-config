      ...
      lib.foldlAttrs (
        ...
        in
          lib.foldlAttrs (
            ...
            in
              if acc ? "${hostname}"
              then throw "Duplicate Linux hostname '${hostname}' found in hosts/*-linux/. Hostnames must be unique across Linux architectures."
              else
                acc
                // {
                  "${hostname}" = {
          ...
          inputs.system-manager.lib.makeSystemConfig {
            modules =
              ...
              ++ (
                ...
                in
                  if builtins.pathExists systemNix
          ...
          inputs.home-manager.lib.homeManagerConfiguration {
            ...
            modules =
              ...
              ++ (
                ...
                in
                  if builtins.pathExists homeNix
                  then [homeNix]
                  else []
              );
          }
